...
public class Parser {
    ...
    Node expr(int p) {
        ...
        if (this.token.tokentype == TokenType.LeftParen) {
            ...
            Main.error(this.token.line, this.token.pos, "Expecting a primary, found: " + this.token.tokentype);
        }
    ...
    void expect(String msg, TokenType s) {
        ...
        Main.error(this.token.line, this.token.pos, msg + ": Expecting '" + s + "', found: '" + this.token.tokentype + "'");
    }
    ...
    Node stmt() {
        ...
        if (this.token.tokentype == TokenType.Keyword_if) {
            ...
            Main.error(this.token.line, this.token.pos, "Expecting start of statement, found: " + this.token.tokentype);
        }
        return t;
    }
